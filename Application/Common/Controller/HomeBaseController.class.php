...
class HomeBaseController extends BaseController{
    ...
    public function _initialize(){
        ...
        $assign=array(
            ...
            'show_link'=>$show_link,
            'all_article'=>D('Article')->getCountData(array('is_show'=>1,'is_delete'=>0)),
            'all_comment'=>M('Comment')->where(array('is_delete'=>0,'status'=>1))->count(),
            'all_chat'=>D('Chat')->getCountData(array('is_show'=>1,'is_delete'=>0)),
            'all_user'=>M('Oauth_user')->count()
            );
        $this->assign($assign);
    }
